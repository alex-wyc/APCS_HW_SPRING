...
PImage pictureText(int width, int height, String text) {
...
void mazeGen(int X, int Y) {
  randgen = new Random();
  color road = color(255);
  color wall = color(0);
  color exit = color(255, 0, 0);
  color start = color(0, 0, 255);
...
void pushAllNeighbor(int X, int Y, Position current) {
...
void shuffleArray(Position[] arr) {
